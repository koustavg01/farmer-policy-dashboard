...
def load_data():
    return [
        {
            "cluster": 3,
            "name": "Stable Dairying Entrepreneurs",
            "tier": "Top",
            "rank": 1,
            "description": "Well-established dairy farmers with stable income and growth potential",
            "color": "#1f77b4",
            "policies": [
                {"name": "Premium Dairy Infrastructure Support", "scheme": "National Livestock Mission + AP Dairy Development", "budget": "₹5-10 lakhs", "priority": "High"},
        ...
        {
            "cluster": 2,
            "name": "Dairying-Focused Commercial Farmers",
            "tier": "Top",
            "rank": 2,
            "description": "Commercial dairy farmers with expansion potential",
            "color": "#ff7f0e",
            "policies": [
                {"name": "Dairy Expansion Loans", "scheme": "NABARD + AP State Cooperative Banks", "budget": "₹3-8 lakhs", "priority": "High"},
        ...
        {
            "cluster": 4,
            "name": "Mixed-Income Marginal Farmers",
            "tier": "Mid",
            "rank": 3,
            "description": "Farmers with diverse income sources but limited resources",
            "color": "#2ca02c",
            "policies": [
                {"name": "Integrated Farming System Support", "scheme": "MGNREGA + RKVY", "budget": "₹1-3 lakhs", "priority": "High"},
        ...
        {
            "cluster": 6,
            "name": "Aspiring Diversified Farmers",
            "tier": "Mid",
            "rank": 4,
            "description": "Farmers seeking to diversify their agricultural activities",
            "color": "#d62728",
            "policies": [
                {"name": "Horticulture and Cash Crop Promotion", "scheme": "MIDH", "budget": "₹2-4 lakhs", "priority": "High"},
        ...
        {
            "cluster": 1,
            "name": "Dairying-Only Subsistence Farmers",
            "tier": "Mid",
            "rank": 5,
            "description": "Small-scale dairy farmers focused on subsistence",
            "color": "#9467bd",
            "policies": [
                {"name": "Dairy Animal Enhancement", "scheme": "NLM + AP Livestock Development", "budget": "₹50,000-2 lakhs", "priority": "High"},
        ...
        {
            "cluster": 0,
            "name": "Diversified Low-Income Farmers",
            "tier": "Low",
            "rank": 6,
            "description": "Small farmers with multiple low-income activities",
            "color": "#8c564b",
            "policies": [
                {"name": "Livelihood Diversification Support", "scheme": "MGNREGA + DAY", "budget": "₹50,000-1.5 lakhs", "priority": "High"},
        ...
        {
            "cluster": 5,
            "name": "Multi-Livestock Low-Income Farmers",
            "tier": "Low",
            "rank": 7,
            "description": "Farmers with multiple livestock but low income",
            "color": "#e377c2",
            "policies": [
                {"name": "Livestock Health and Nutrition", "scheme": "NADCP", "budget": "₹25,000-1 lakh", "priority": "High"},
        ...
        {
            "cluster": 8,
            "name": "Potential But Currently Dormant",
            "tier": "Low",
            "rank": 8,
            "description": "Farmers with potential but currently inactive",
            "color": "#7f7f7f",
            "policies": [
                {"name": "Agricultural Revival Package", "scheme": "AP Farmer Revival Mission", "budget": "₹1-2 lakhs", "priority": "High"},
        ...
        {
            "cluster": 7,
            "name": "Inactive or Dormant Farmers",
            "tier": "Low",
            "rank": 9,
            "description": "Currently inactive farmers needing basic support",
            "color": "#bcbd22",
            "policies": [
                {"name": "Emergency Livelihood Support", "scheme": "MGNREGA + PM-KISAN", "budget": "₹20,000-75,000", "priority": "High"},
        ...
        {
            "cluster": 9,
            "name": "Extremely Low-Income Farmers",
            "tier": "Low",
            "rank": 10,
            "description": "Farmers in extreme poverty needing comprehensive support",
            "color": "#17becf",
            "policies": [
                {"name": "Comprehensive Welfare Package", "scheme": "AAY + IG Pension", "budget": "₹50,000-1 lakh/year", "priority": "High"},
...
rank_df = pd.DataFrame([
    {"Cluster": f"{c['cluster']}: {c['name']}", "Rank": c["rank"], "Color": c["color"]}
...
st.dataframe(heatmap_data.style.background_gradient(cmap="RdYlGn", axis=0))
